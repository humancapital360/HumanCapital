  ...
  return (
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-start">
              <Image
                ...
                width={250}
                height={50}
                className="h-[80px] w-[250px] brightness-0 invert"
              />
            </div>
            <p className="text-gray-400 text-base">
              Human Capital 360 is consulting and training powerhouse of eclectic business leaders and innovators dedicated to the empowerment and transformation of marginalized communities nationwide.<br />
        ...
        {/* Social Media Icons */}
                <div
                  className="flex gap-2 xs:gap-3 sm:gap-4 justify-center lg:justify-end animate-slide-in-left"
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>
            ...
            <Link href="https://linkedin.com/in/charles-harrison" target="_blank">
              Developed By <span className="text-white hover:text-white/70">Charles Onuoha</span>
            </Link>
          </p>
        </div>
      </div>
