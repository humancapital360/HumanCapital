...
export default function TeamPage() {
  const executiveTeam = [
    ...
    },
    {
      ...
      badge: "CAO",
      fullBio:
        "Lauren Fireman is a Chief Administrative Officer who lives at the intersection of HR and IT and knows how to make both actually work together. With over 25 years of experience as a solutions architect, technology strategist, global systems leader, and consultant, she brings real structure and discipline to the CAO role, ensuring that people, process, and platforms stay aligned to the business.<br /><br />Lauren has led large-scale Workday implementations across more than 30 countries for Fortune 500 companies, delivering secure, scalable, and genuinely user-centric solutions. Her results are concrete, not theoretical. As a consultant, she has driven efficiency gains of 35 to 45 percent within six months and has consistently maintained customer satisfaction rates above 90 percent. She is known for balancing innovation with governance, modernizing HR and IT while maintaining tight controls, ensuring compliance remains intact, and long-term organizational goals front and center.<br /><br />Her leadership experience includes roles at Apollo Global Management, MUFG Securities Americas, BlackRock, and UniCredit, as well as independent consulting through HROptimize LLC. She holds a dual MBA in Human Resources and Information Systems from the University at Albany, SUNY, mirroring the combined HR and IT remit she now owns as CAO. Grounded in strong family and community values, Lauren currently serves as Treasurer of her daughter’s Girl Scout troop. She volunteers with the Pleasantville PTA, where she serves on the committee that runs the Walk In My Shoes empathy program, and with the Pleasantville Fund for Learning, where she helps manage the backend of the annual Brick Laying ceremony. She is a member of Lasagna Love, cooking for families in need of food support, and an avid dog lover who spent over 10 years volunteering in rescue work, including fostering dogs.<br /><br /> A mother of three, with one son and twin daughters, Lauren is passionate about teaching financial literacy, a discipline passed down from her grandfather. She believes these fundamentals should be treated as non-negotiable life skills. She also enjoys trying different kinds of food and traveling with her family to experience other cultures, bringing that broader perspective back into how she leads, advises, and builds organizations.",
      socialMedia: {
