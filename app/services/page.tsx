...
const serviceDetails = [
    {
      ...
      image: "/images/programs/ncc-program.jpg?height=400&width=800&text=NCC+Strategy",
    },
    {
      title: "Neighborhood Eco Life Service Request (NELSR) System",
      content:
        "Our Neighborhood Eco Life Service Request (NELSR) is an innovative platform designed to enhance community engagement and streamline issue resolution. Unlike traditional, linear city communication models, NELSR enables residents to submit informal grievances, upload supporting photographs, and receive a response ticket. When necessary, members of our Environmental Service Technicians (i.e., junk, trash, pest, insects, and landscaping) are dispatched, and thereon an incident report is generated. By giving residents a voice, NELSR fosters empathy, validation, and a sense of partnership. These positive dynamics encourage individuals to take ownership of their community and strengthen their connection to the neighborhood.",
      image: "/images/programs/NELSR.jpg?height=400&width=800&text=NQR+System",
    },
    {
      title: "My Neighbor",
      content:
      ...
      image: "/images/programs/my-neighbor-robot.jpg?height=400&width=800&text=My+Neighbor+Robots",
    },
    {
      ...
      image: "/images/programs/reentry.jpg?height=400&width=800&text=Reentry+Workforce",
    },
    {
      ...
      image: "/images/programs/community-service.jpg?height=400&width=800&text=Community+Services",
    },
  ]
