...
import { ArrowRight, Users, Target, Award, Star, Zap, Shield, Globe, TrendingUp, HeartHandshake, CheckCircle, Lightbulb, Leaf } from "lucide-react"
        ...
        <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden -mt-[170px] pt-[180px] pb-[70px]">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="text-center space-y-8">
              ...
              >
                Empowering transformation through innovation, one neighborhood at a time. Discover the mission, vision, and
                values that drive our commitment to community development.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid gap-12 lg:grid-cols-2 items-center">
              <div className="space-y-8 animate-slide-in-left">
                ...
                <div>
                  ...
                  <Link target="_blank" href="/docs/hc360-company-profile.pdf" passHref>
                    <Button
                      size="sm"
              ...
              <div className="relative animate-slide-in-right">
                <Image
                  src="/images/about-us-img.png?height=600&width=800"
                  width={800}
                  height={600}
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-sm xs:text-base sm:text-lg text-gray-600 max-w-3xl mx-auto px-4">
                Beyond our core features, we offer comprehensive support systems designed to ensure your long-term success and sustainable growth.
              </p>
            </div>
                  ...
                  <div className={`relative ${index % 2 === 1 ? "lg:col-start-1" : ""}`}>
                    <Card className="border-0 shadow-2xl overflow-hidden w-[90%] mx-auto md:w-full">
                      <CardContent className="p-0">
                        ...
                        >
                          <feature.icon className="w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 text-white/20" />
                        </div>
                      </CardContent>
                    </Card>
                  </div>
